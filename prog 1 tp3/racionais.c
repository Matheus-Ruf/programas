 ...
 * A memoria para o numero racional deve ser alocada dinamicamente
 ...
 * esta no parametro.
 * A memoria para o n̼mero racional deve ser alocada dinamicamente
 * nesta fun̤̣o. O racional apontado pelo ponteiro deve ser retornado
 * na forma simplificada, conforme especificado acima.
 * A funcao retorna NULL em caso de falha na alocacao */
 ...
 * Quem chama esta funcao deve garantir que *r seja valido e nao NULL.
 * A memoria para o n̼mero racional deve ser alocada dinamicamente
 * nesta fun̤̣o. Retorna NULL se nao conseguiu alocar a memoria ou
